...
cc -g3 -fsanitize=address src/builtins/*.c src/libft/*.c src/signal/*.c src/execute/*.c src/get_input/*.c src/input_parse/*.c src/print/*.c -lreadline -L/Users/youngwch/.brew/opt/readline/lib -I/Users/youngwch/.brew/opt/readline/include
